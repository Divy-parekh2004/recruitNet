        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-5 text-center mt-5 mt-lg-0">
                <div class="hero-logo-container">
                    ...
                    <div class="balloon-circle" style="top: 10%; left: 5%; width: 30px; height: 30px; background: #FF7A3D;"></div>
                    <div class="balloon-circle" style="top: 60%; left: 80%; width: 45px; height: 45px; background: #0A3B5B;"></div>
                    <div class="balloon-circle" style="top: 20%; left: 70%; width: 25px; height: 25px; background: #FFB347;"></div>
                    <div class="balloon-circle" style="top: 70%; left: 15%; width: 35px; height: 35px; background: #4A90E2;"></div>
                    <div class="balloon-circle" style="top: 40%; left: 40%; width: 50px; height: 50px; background: #FF7A3D; opacity: 0.2;"></div>

                    <div class="floating-text-logo">
                        <span class="recruit-part">Recruit</span>
                        <span class="net-part">Net</span>
                    </div>
                </div>
            </div>
        </div>
